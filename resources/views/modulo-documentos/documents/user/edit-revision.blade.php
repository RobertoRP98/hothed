...
<div class="container">
    ...
    <form action="{{ url('/documentacion-sgi/' . $document->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        {{method_field('PATCH')}}    
 <H1>Autorizar revisión documento "{{$document->name}}"</H1>
 ...
 @endphp
    ...
    <br>
 <div class="row mb-4 col-md-12" hidden> 
     <div class="col-md-2">
         <div data-mdb-input-init class="form-outline">
             <label class="form-label" for="code">&nbsp; CÓDIGO</label>
             <label type="text" id="code" name="code" value="{{ old('code', $document->code ?? '') }}"
...
<div class="col-md-2">
    <div class="form-outline">
        ...
        <span class="form-control-plaintext">
            {{ $users->firstWhere('id', $document->revisor_id)->name ?? 'Sin asignar' }}
        </span>
    </div>
</div>
...
<div class="col-md-2">
    <div class="form-outline">
        <label class="form-label" for="revisor_id">&nbsp;REVISOR</label>
        <span class="form-control-plaintext">
            {{ $users->firstWhere('id', $document->aprobador_id)->name ?? 'Sin asignar' }}
        </span>
    </div>
</div>
