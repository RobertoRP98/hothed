...
<div class="col-md-12">
    ...
    <a href="{{ url('/requisiciones-subope-autorizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Autorizadas
    </a>

    <a href="{{ url('/requisiciones-subope-canceladas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Canceladas
    </a>

    <a href="{{ url('/requisiciones-subope-finalizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
...
<thead class="thead-light">
    ...
    <tbody>
        @foreach($requisitionsubope as $requisicion)
        <tr>
