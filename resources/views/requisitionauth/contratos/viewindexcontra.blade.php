...
<div class="col-md-12">
    ...
    <a href="{{ url('/requisiciones-contratos-autorizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Autorizadas
    </a>

    <a href="{{ url('/requisiciones-contratos-canceladas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Canceladas
    </a>

    <a href="{{ url('/requisiciones-contratos-finalizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
...
<h3 class="text-center my-4">Requisiciones de Contratos</h3>
...
<div class="card">
    ...
    <table id="requiop" class="table table-light table-bordered table-hover text-center">
<thead class="thead-light">
    ...
    <tbody>
        @foreach($requisitioncontra as $requisicion)
        <tr>
