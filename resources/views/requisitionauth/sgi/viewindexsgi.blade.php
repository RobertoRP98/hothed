...
<div class="col-md-12">
    ...
    <a href="{{ url('/requisiciones-sgi-autorizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Autorizadas
    </a>

    <a href="{{ url('/requisiciones-sgi-canceladas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Canceladas
    </a>

    <a href="{{ url('/requisiciones-sgi-finalizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
...
<h3 class="text-center my-4">Requisiciones de HSE-SGI</h3>
...
<thead class="thead-light">
    ...
    <tbody>
        @foreach($requisitionsgi as $requisicion)
        <tr>
