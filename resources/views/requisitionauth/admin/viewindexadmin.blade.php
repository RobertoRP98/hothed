...
<div class="col-md-12">
    ...
    <a href="{{ url('/requisiciones-admin-autorizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Autorizadas
    </a>

    <a href="{{ url('/requisiciones-admin-canceladas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Canceladas
    </a>

    <a href="{{ url('/requisiciones-admin-finalizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
...
<thead class="thead-light">
    ...
    <tbody>
        @foreach($requisitionadmin as $requisicion)
        <tr>
