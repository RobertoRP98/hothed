...
<div class="d-flex flex-wrap mt-3">
    <a href="{{ url('/requisiciones-administracion') }}" class="btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Regresar
    </a>   
</div>
...
<h3 class="text-center my-4">Requisiciones Canceladas de Administración</h3>
