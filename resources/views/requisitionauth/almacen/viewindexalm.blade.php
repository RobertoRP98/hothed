...
<div class="col-md-12">
    ...
    <a href="{{ url('/requisiciones-almacen-autorizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Autorizadas
    </a>

    <a href="{{ url('/requisiciones-almacen-canceladas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones Canceladas
    </a>

    <a href="{{ url('/requisiciones-almacen-finalizadas') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
...
<h3 class="text-center my-4">Requisiciones de Almacén</h3>
...
<thead class="thead-light">
    ...
    <tbody>
        @foreach($requisitionalm as $requisicion)
        <tr>
