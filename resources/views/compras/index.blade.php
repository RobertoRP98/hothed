...
@section('indexsupplier')
    <div class="container">
        ...
        <div class="col-md-12">
            ...
            <a href="{{ url('/ordenes-compra/pendientes') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                Ordenes Pendientes de Autorización
            </a>

            <a href="{{ url('/ordenes-compra/rechazadas') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                Ordenes Canceladas
            </a>

            <a href="{{ url('/ordenes-compra/finalizadas') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                Ordenes Finalizadas
            </a>

            <a href="{{ url('/ordenes-compra/facturadas') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                Ordenes Facturadas
            </a>

            <a href="{{ url('/ordenes-compra/no-facturadas') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                Ordenes No Facturadas
            </a>

            <a href="{{ url('/ordenes-compra/pagadas') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                Ordenes Pagadas
            </a>
        </div>
        ...
        <div class="d-flex flex-wrap">
            ...
            <a href="{{ url('/export-compras-locales') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                REPORTE COMPRAS LOCALES
            </a>

            <a href="{{ url('/export-compras-extranjeras') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                REPORTE COMPRAS EXTRANJERAS
            </a>

            <a href="{{ url('/compras-por-fechas') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                REPORTE POR RANGOS
            </a>

            <a href="{{ url('/export-compras-global') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                REPORTE GLOBAL DE COMPRAS
            </a>

            <a href="{{ url('/export-proveedores') }}"
                class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
                        ...
                        <tbody>
                            @foreach ($datosoc as $oc)
                                <tr>
                                    ...
                                    <td data-order="{{ $oc->id }}">
                                        {{ 'VH-' . $oc->id . '-' . $oc->created_at->format('y') }}</td>
                                    ...
                                    <td
                                        class="
    @if (\Carbon\Carbon::parse($oc->requisition->production_date)->diffInDays(now(), false) >= -15) table-danger text-danger fw-bold
        ...
        table-success @endif">
            ...
            @else
                table-success @endif">
                                    ...
                                    <td>
                                        <a class="text-white"
                                            href="{{ route('ordencompra.show', ['purchaseOrder' => $oc->id, 'requisicione' => $oc->requisition->id]) }}"
                                            target="_blank">
                                        ...
                                        <a class="text-white"
                                            href="{{ route('ordencompra.edit', ['purchaseOrder' => $oc->id, 'requisicione' => $oc->requisition->id]) }}"
                                            target="_blank">
                                        ...
                                        <a class="text-white"
                                            href="{{ route('ordencompra.pdf', ['purchaseOrder' => $oc->id, 'requisicione' => $oc->requisition->id]) }}">
