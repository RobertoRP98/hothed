...
<div class="d-flex flex-wrap mt-3">
    <a href="{{ url('/requisiciones-beta') }}" class="btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Requisiciones
    </a>

    <a href="{{ url('/requisiciones-beta/create') }}" class="btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        Crear Requisiciones
    </a>
...
<thead class="thead-light">
    ...
    <tbody>
        @foreach($requisiciones as $requis)
        <tr>
            ...
            <td>
               <button class="btn btn-warning mb-2"> <a class="text-white" href="{{ url('requisiciones-beta/'.$requis->id) }}">
                    Editar
                </a> </button> 
            </td>
        </tr>
