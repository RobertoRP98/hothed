...
<div class="col-md-12">
    <a href="{{ url('/ordenes-compra/pre-autorizacio/adm/pendientes') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        PRE-AUT PENDIENTES
    </a>
...
<h3 class="text-center my-1">AUTORIZADAS DE PREAUTORIZACIÓN - ADMINISTRACIÓN</h3>
