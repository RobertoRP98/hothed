...
<div class="col-md-12">
    <a href="{{ url('/ordenes-compra/autorizacion/pendientes') }}" class="col-md-3 btn btn-lg btn-light border border-primary shadow-sm m-2 w-auto">
        COMPRAS PENDIENTES DE AUTORIZACIÓN
    </a>
...
<h3 class="text-center my-1">COMPRAS AUTORIZADAS</h3>
    ...
    @endif
        ...
        <td>{{ $oc->po_status }}</td> 
            ...
            <td>
                ...
                <a class="text-white" href="{{ route('autdir.edit', ['purchaseOrder' => $oc->id, 'requisicione' => $oc->requisition->id]) }}"
                    >
