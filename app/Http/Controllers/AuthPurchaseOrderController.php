...
class AuthPurchaseOrderController extends Controller
{
    ...
    public function editpreaut($id, $requisicione) //ESTE ALIMENTA AL COMPONENTE PRE AUTORIZACION OPE Y ADM
    {
        ...
        // dd($initialData);
        return view('compraspreaut.adm.editpreaut', compact('order', 'today', 'proveedor', 'producto', 'item', 'days_remaining_now', 'initialData'));
    }
